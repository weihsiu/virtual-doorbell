...
function $s_Lscalatags_generic_Attrs$class__disabled__Lscalatags_generic_Attrs__Lscalatags_generic_AttrPair($$this) {
  var this$1 = $s_Lscalatags_generic_Util$class__attr__Lscalatags_generic_Util__T__Lscalatags_generic_Namespace__Z__Lscalatags_generic_Attr($$this, "disabled", null, false);
...
/** @constructor */
function $c_Lvdb_doorbell_DoorbellMain$() {
  $c_O.call(this)
}
$c_Lvdb_doorbell_DoorbellMain$.prototype = new $h_O();
$c_Lvdb_doorbell_DoorbellMain$.prototype.constructor = $c_Lvdb_doorbell_DoorbellMain$;
/** @constructor */
function $h_Lvdb_doorbell_DoorbellMain$() {
  /*<skip>*/
}
$h_Lvdb_doorbell_DoorbellMain$.prototype = $c_Lvdb_doorbell_DoorbellMain$.prototype;
$c_Lvdb_doorbell_DoorbellMain$.prototype.init___ = (function() {
  return this
});
$c_Lvdb_doorbell_DoorbellMain$.prototype.ring__T__T__s_concurrent_Future = (function(apiKey, sid) {
  var s = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["{\"registration_ids\":[\"", "\"]}"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([sid]));
  var jsx$1 = new $c_T2().init___O__O("Content-Type", "application/json");
  var y = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["key=", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([apiKey]));
  var array = [jsx$1, new $c_T2().init___O__O("Authorization", y)];
  ...
  var x$7 = $as_sci_Map(this$7.elems$1);
  var this$8 = $m_Lorg_scalajs_dom_ext_Ajax$();
  var this$9 = this$8.apply__T__T__Lorg_scalajs_dom_ext_Ajax$InputData__I__sci_Map__Z__T__s_concurrent_Future("POST", "https://android.googleapis.com/gcm/send", s, 0, x$7, false, "json");
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(r$2) {
    return r$2.response
  }));
  var executor = $m_sjs_concurrent_JSExecutionContext$Implicits$().queue$1;
  return $s_s_concurrent_Future$class__map__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$9, f, executor)
});
$c_Lvdb_doorbell_DoorbellMain$.prototype.main__Lorg_scalajs_dom_raw_Element__V = (function(content) {
  var apiKey = this.queryVariable__T__s_Option("apiKey");
  var sid = this.queryVariable__T__s_Option("sid");
  var jsx$11 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("container", $m_Lscalatags_JsDom$all$().stringAttr$1)]));
  var jsx$10 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("row", $m_Lscalatags_JsDom$all$().stringAttr$1)]));
  var jsx$9 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-xs-12", $m_Lscalatags_JsDom$all$().stringAttr$1)]));
  var jsx$8 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("jumbotron", $m_Lscalatags_JsDom$all$().stringAttr$1)]));
  var jsx$7 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().h1__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Virtual Doorbell"))]));
  var jsx$6 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Press the Ring button to ring the virtual doorbell, anywhere in the world."))]));
  var jsx$5 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().button__Lscalatags_generic_TypedTag());
  var jsx$4 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("btn btn-default", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$3 = ((apiKey.isEmpty__Z() || sid.isEmpty__Z()) ? $m_Lscalatags_JsDom$all$().disabled__Lscalatags_generic_AttrPair().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("disabled", $m_Lscalatags_JsDom$all$().stringAttr$1) : ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("")));
  var jsx$2 = $m_Lscalatags_JsDom$all$().onclick__Lscalatags_generic_Attr();
  var jsx$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(apiKey$1, sid$1) {
    return (function() {
      return $m_Lvdb_doorbell_DoorbellMain$().ring__T__T__s_concurrent_Future($as_T(apiKey$1.get__O()), $as_T(sid$1.get__O()))
    })
  })(apiKey, sid));
  ...
  var container = jsx$11.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$10.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$9.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$8.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$7, jsx$6, jsx$5.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$4, jsx$3, jsx$2.$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair(jsx$1, new $c_Lscalatags_LowPriorityImplicits$$anon$2().init___Lscalatags_LowPriorityImplicits__F1(this$4, ev))])).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Ring"))]))]))]))]))])).render__Lorg_scalajs_dom_raw_Element();
  content.appendChild(container)
});
$c_Lvdb_doorbell_DoorbellMain$.prototype.queryVariable__T__s_Option = (function(name) {
  try {
    var x = $as_T($m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().location.search);
    var this$3 = new $c_sci_StringOps().init___T(x);
    var jsx$1 = new $c_s_util_Success().init___O($as_T($s_sc_IndexedSeqOptimized$class__tail__sc_IndexedSeqOptimized__O(this$3)))
  } catch (e) {
  ...
  var query = jsx$1.toOption__s_Option();
  if (query.isEmpty__Z()) {
    ...
    var xs = $s_sci_StringLike$class__split__sci_StringLike__C__AT(this$5, 38);
    var elems$2 = [];
    var i = 0;
    var len = xs.u.length;
    while ((i < len)) {
      ...
      var elem = $s_sci_StringLike$class__split__sci_StringLike__C__AT(this$17, 61);
      var unboxedElem = ((elem === null) ? null : elem);
      elems$2.push(unboxedElem);
      i = ((1 + i) | 0)
    };
    var xs$1 = $makeNativeArrayWrapper($d_T.getArrayOf().getArrayOf(), elems$2);
    var elems$2$1 = [];
    var i$1 = 0;
    ...
    while ((i$1 < len$1)) {
      ...
      var kv = $asArrayOf_T(arg1$1, 1);
      var elem$1 = new $c_T2().init___O__O($as_T($g.decodeURIComponent(kv.u[0])), $as_T($g.decodeURIComponent(kv.u[1])));
      elems$2$1.push(elem$1);
      i$1 = ((1 + i$1) | 0)
    };
    var xs$2 = $makeNativeArrayWrapper($d_T2.getArrayOf(), elems$2$1);
    var len$2 = xs$2.u.length;
    var i$2 = 0;
    while (true) {
      if ((i$2 < len$2)) {
        var index$2 = i$2;
        var arg1$2 = xs$2.u[index$2];
        var x$3 = $as_T2(arg1$2);
        var x$4 = x$3.$$und1$f;
        var jsx$2 = (!((x$4 === null) ? (name === null) : $objectEquals(x$4, name)))
      } else {
        var jsx$2 = false
      };
      if (jsx$2) {
    ...
    var i$3 = i$2;
    var this$31 = ((i$3 < xs$2.u.length) ? new $c_s_Some().init___O(xs$2.u[i$3]) : $m_s_None$())
  };
  if (this$31.isEmpty__Z()) {
    return $m_s_None$()
  } else {
    var arg1$3 = this$31.get__O();
    var x$4$1 = $as_T2(arg1$3);
    return new $c_s_Some().init___O($as_T(x$4$1.$$und2$f))
  }
});
$c_Lvdb_doorbell_DoorbellMain$.prototype.$$js$exported$meth$main__Lorg_scalajs_dom_raw_Element__O = (function(content) {
  this.main__Lorg_scalajs_dom_raw_Element__V(content)
});
$c_Lvdb_doorbell_DoorbellMain$.prototype.main = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$main__Lorg_scalajs_dom_raw_Element__O(prep0)
});
var $d_Lvdb_doorbell_DoorbellMain$ = new $TypeData().initClass({
  Lvdb_doorbell_DoorbellMain$: 0
}, false, "vdb.doorbell.DoorbellMain$", {
  Lvdb_doorbell_DoorbellMain$: 1,
  O: 1
});
$c_Lvdb_doorbell_DoorbellMain$.prototype.$classData = $d_Lvdb_doorbell_DoorbellMain$;
var $n_Lvdb_doorbell_DoorbellMain$ = (void 0);
function $m_Lvdb_doorbell_DoorbellMain$() {
  if ((!$n_Lvdb_doorbell_DoorbellMain$)) {
    $n_Lvdb_doorbell_DoorbellMain$ = new $c_Lvdb_doorbell_DoorbellMain$().init___()
  };
  return $n_Lvdb_doorbell_DoorbellMain$
}
$e.vdb = ($e.vdb || {});
$e.vdb.doorbell = ($e.vdb.doorbell || {});
$e.vdb.doorbell.DoorbellMain = $m_Lvdb_doorbell_DoorbellMain$;
/** @constructor */
function $c_Lvdb_mqtt_MqttTest$() {
  $c_O.call(this)
}
$c_Lvdb_mqtt_MqttTest$.prototype = new $h_O();
$c_Lvdb_mqtt_MqttTest$.prototype.constructor = $c_Lvdb_mqtt_MqttTest$;
/** @constructor */
function $h_Lvdb_mqtt_MqttTest$() {
  /*<skip>*/
}
$h_Lvdb_mqtt_MqttTest$.prototype = $c_Lvdb_mqtt_MqttTest$.prototype;
$c_Lvdb_mqtt_MqttTest$.prototype.init___ = (function() {
  return this
});
$c_Lvdb_mqtt_MqttTest$.prototype.main__Lorg_scalajs_dom_raw_Element__V = (function(content) {
  var client = new $g.Paho.MQTT.Client("broker.hivemq.com", 8000, "/test123", "client123");
  client.onConnectionLost = (function(e$2) {
    var x = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["connection lost: ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$as_T(e$2.errorMessage)]));
    var this$2 = $m_s_Console$();
    var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
    this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V((x + "\n"))
  });
  client.onMessageArrived = (function(m$2) {
    var x$1 = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["message arrived: ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$as_T(m$2.payloadString)]));
  ...
  client.connect($m_Lvdb_mqtt_Paho$ConnectOptions$().apply__F1__Lvdb_mqtt_Paho$ConnectOptions(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(client$1) {
    return (function(x$1$2) {
      var this$8 = $m_s_Console$();
      var this$9 = $as_Ljava_io_PrintStream(this$8.outVar$2.v$1);
      this$9.java$lang$JSConsoleBasedPrintStream$$printString__T__V("connected\n");
      client$1.subscribe("/test123");
      var message = new $g.Paho.MQTT.Message("hello world!");
      message.destinationName = "/test123";
      client$1.send(message)
    })
  })(client))))
});
$c_Lvdb_mqtt_MqttTest$.prototype.$$js$exported$meth$main__Lorg_scalajs_dom_raw_Element__O = (function(content) {
  this.main__Lorg_scalajs_dom_raw_Element__V(content)
});
$c_Lvdb_mqtt_MqttTest$.prototype.main = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$main__Lorg_scalajs_dom_raw_Element__O(prep0)
});
var $d_Lvdb_mqtt_MqttTest$ = new $TypeData().initClass({
  Lvdb_mqtt_MqttTest$: 0
}, false, "vdb.mqtt.MqttTest$", {
  Lvdb_mqtt_MqttTest$: 1,
  O: 1
});
$c_Lvdb_mqtt_MqttTest$.prototype.$classData = $d_Lvdb_mqtt_MqttTest$;
var $n_Lvdb_mqtt_MqttTest$ = (void 0);
function $m_Lvdb_mqtt_MqttTest$() {
  if ((!$n_Lvdb_mqtt_MqttTest$)) {
    $n_Lvdb_mqtt_MqttTest$ = new $c_Lvdb_mqtt_MqttTest$().init___()
  };
  return $n_Lvdb_mqtt_MqttTest$
}
$e.vdb = ($e.vdb || {});
$e.vdb.mqtt = ($e.vdb.mqtt || {});
$e.vdb.mqtt.MqttTest = $m_Lvdb_mqtt_MqttTest$;
/** @constructor */
function $c_Lvdb_mqtt_Paho$ConnectOptions$() {
  $c_O.call(this)
}
$c_Lvdb_mqtt_Paho$ConnectOptions$.prototype = new $h_O();
$c_Lvdb_mqtt_Paho$ConnectOptions$.prototype.constructor = $c_Lvdb_mqtt_Paho$ConnectOptions$;
/** @constructor */
function $h_Lvdb_mqtt_Paho$ConnectOptions$() {
  /*<skip>*/
}
$h_Lvdb_mqtt_Paho$ConnectOptions$.prototype = $c_Lvdb_mqtt_Paho$ConnectOptions$.prototype;
$c_Lvdb_mqtt_Paho$ConnectOptions$.prototype.init___ = (function() {
  return this
});
$c_Lvdb_mqtt_Paho$ConnectOptions$.prototype.apply__F1__Lvdb_mqtt_Paho$ConnectOptions = (function(onSuccess) {
  return {
...
var $d_Lvdb_mqtt_Paho$ConnectOptions$ = new $TypeData().initClass({
  Lvdb_mqtt_Paho$ConnectOptions$: 0
}, false, "vdb.mqtt.Paho$ConnectOptions$", {
  Lvdb_mqtt_Paho$ConnectOptions$: 1,
  O: 1
});
$c_Lvdb_mqtt_Paho$ConnectOptions$.prototype.$classData = $d_Lvdb_mqtt_Paho$ConnectOptions$;
var $n_Lvdb_mqtt_Paho$ConnectOptions$ = (void 0);
function $m_Lvdb_mqtt_Paho$ConnectOptions$() {
  if ((!$n_Lvdb_mqtt_Paho$ConnectOptions$)) {
    $n_Lvdb_mqtt_Paho$ConnectOptions$ = new $c_Lvdb_mqtt_Paho$ConnectOptions$().init___()
  };
  return $n_Lvdb_mqtt_Paho$ConnectOptions$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
$c_Lscalatags_generic_AttrPair.prototype.$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair = (function(v, ev) {
  ...
  return new $c_Lscalatags_generic_AttrPair().init___Lscalatags_generic_Attr__O__Lscalatags_generic_AttrValue(this.a$1, v, ev)
});
...
$c_Lscalatags_JsDom$all$.prototype.disabled$lzycompute__p1__Lscalatags_generic_AttrPair = (function() {
  ...
  var hi = (4 & b.hi$2);
  if ((hi === 0)) {
    this.disabled$1 = $s_Lscalatags_generic_Attrs$class__disabled__Lscalatags_generic_Attrs__Lscalatags_generic_AttrPair(this);
...
//# sourceMappingURL=doorbell-fastopt.js.map

...
/** @constructor */
function $c_Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$() {
  $c_O.call(this)
}
$c_Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$.prototype = new $h_O();
$c_Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$.prototype.constructor = $c_Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$;
/** @constructor */
function $h_Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$() {
  /*<skip>*/
}
$h_Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$.prototype = $c_Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$.prototype;
$c_Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$.prototype.init___ = (function() {
  return this
});
$c_Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$.prototype.apply__Z__Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions = (function(userVisibleOnly) {
  return {
    "userVisibleOnly": userVisibleOnly
  }
});
var $d_Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$ = new $TypeData().initClass({
  Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$: 0
}, false, "org.scalajs.dom.experimental.push.PushSubscriptionOptions$", {
  Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$: 1,
  O: 1
});
$c_Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$.prototype.$classData = $d_Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$;
var $n_Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$ = (void 0);
function $m_Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$() {
  if ((!$n_Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$)) {
    $n_Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$ = new $c_Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$().init___()
  };
  return $n_Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$
}
/** @constructor */
...
/** @constructor */
function $c_Lvdb_ringer_RingerMain$() {
  $c_O.call(this)
}
$c_Lvdb_ringer_RingerMain$.prototype = new $h_O();
$c_Lvdb_ringer_RingerMain$.prototype.constructor = $c_Lvdb_ringer_RingerMain$;
/** @constructor */
function $h_Lvdb_ringer_RingerMain$() {
  /*<skip>*/
}
$h_Lvdb_ringer_RingerMain$.prototype = $c_Lvdb_ringer_RingerMain$.prototype;
$c_Lvdb_ringer_RingerMain$.prototype.init___ = (function() {
  return this
});
$c_Lvdb_ringer_RingerMain$.prototype.makeUrl__T__T__T = (function(apiKey, sid) {
  var l = $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().location;
  var thiz = $as_T(l.pathname);
  var path = $as_T(thiz.split("ringer").join("doorbell"));
  return new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["", "//", "/", "?apiKey=", "&sid=", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$as_T(l.protocol), $as_T(l.host), path, apiKey, sid]))
});
$c_Lvdb_ringer_RingerMain$.prototype.registerService__T__s_concurrent_Future = (function(url) {
  var jsx$3 = $m_s_concurrent_Future$();
  try {
    var n = $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().navigator;
    var jsx$2 = n.serviceWorker;
  ...
  var this$4 = jsx$3.fromTry__s_util_Try__s_concurrent_Future(jsx$1);
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(url$2) {
    return (function(x$2$2) {
      var jsx$4 = $m_sjs_js_Thenable$ThenableOps$();
      var p = x$2$2.register(url$2);
      return jsx$4.toFuture$extension__sjs_js_Thenable__s_concurrent_Future(p)
    })
  })(url));
  var executor = $m_sjs_concurrent_JSExecutionContext$Implicits$().queue$1;
  return $s_s_concurrent_Future$class__flatMap__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$4, f, executor)
});
$c_Lvdb_ringer_RingerMain$.prototype.main__Lorg_scalajs_dom_raw_Element__V = (function(content) {
  var qrCode = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag($m_sci_Nil$()).render__Lorg_scalajs_dom_raw_Element();
  var url = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().textarea__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag($m_sci_Nil$()).render__Lorg_scalajs_dom_raw_Element();
  ...
  var jsx$7 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("row", $m_Lscalatags_JsDom$all$().stringAttr$1)]));
  ...
  var jsx$5 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("jumbotron", $m_Lscalatags_JsDom$all$().stringAttr$1)]));
  var jsx$4 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().h1__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Virtual Ringer"))]));
  var jsx$3 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Share the following doorbell url with someone."))]));
  var this$3 = $m_Lscalatags_JsDom$all$();
  var jsx$2 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$3, qrCode);
  var jsx$1 = $m_Lscalatags_JsDom$all$().br__Lscalatags_generic_TypedTag();
  var this$4 = $m_Lscalatags_JsDom$all$();
  var container = jsx$8.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$7.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$6.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$5.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$4, jsx$3, jsx$2, jsx$1, new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$4, url)]))]))]))])).render__Lorg_scalajs_dom_raw_Element();
  content.appendChild(container);
  var this$7 = this.registerService__T__s_concurrent_Future("service-fastopt.js");
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x$1$2) {
    var jsx$9 = $m_sjs_js_Thenable$ThenableOps$();
    var p = x$1$2.pushManager.subscribe($m_Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions$().apply__Z__Lorg_scalajs_dom_experimental_push_PushSubscriptionOptions(true));
    return jsx$9.toFuture$extension__sjs_js_Thenable__s_concurrent_Future(p)
  }));
  var executor = $m_sjs_concurrent_JSExecutionContext$Implicits$().queue$1;
  var this$11 = $s_s_concurrent_Future$class__flatMap__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$7, f, executor);
  var f$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(apiKey$1, qrCode$1, url$1) {
    return (function(s$2) {
      var u = $m_Lvdb_ringer_RingerMain$().makeUrl__T__T__T(apiKey$1, $m_Lvdb_ringer_RingerMain$().sid__T__T($as_T(s$2.endpoint)));
      new $g.QRCode(qrCode$1, u);
      url$1.textContent = u
    })
  })("AIzaSyCGQ6g2-HCjdZ1ho5QxX4lCQIAUDIk5eBY", qrCode, url));
  var executor$1 = $m_sjs_concurrent_JSExecutionContext$Implicits$().queue$1;
  $s_s_concurrent_Future$class__foreach__s_concurrent_Future__F1__s_concurrent_ExecutionContext__V(this$11, f$1, executor$1)
});
$c_Lvdb_ringer_RingerMain$.prototype.sid__T__T = (function(endpoint) {
  var this$2 = new $c_sci_StringOps().init___T(".+/send/(.+)");
  var groupNames = $m_sci_Nil$();
  var $$this = this$2.repr$1;
  var Sid = new $c_s_util_matching_Regex().init___T__sc_Seq($$this, groupNames);
  matchEnd4: {
    var sid$2;
    var o7 = Sid.unapplySeq__jl_CharSequence__s_Option(endpoint);
    if ((!o7.isEmpty__Z())) {
      if ((o7.get__O() !== null)) {
        var this$4 = $as_sc_LinearSeqOptimized(o7.get__O());
        var jsx$1 = ($s_sc_LinearSeqOptimized$class__lengthCompare__sc_LinearSeqOptimized__I__I(this$4, 1) === 0)
      } else {
        var jsx$1 = false
      };
      if (jsx$1) {
        var this$5 = $as_sc_LinearSeqOptimized(o7.get__O());
        var sid = $as_T($s_sc_LinearSeqOptimized$class__apply__sc_LinearSeqOptimized__I__O(this$5, 0));
        var sid$2 = sid;
        break matchEnd4
      }
    };
    throw new $c_s_MatchError().init___O(endpoint)
  };
  return sid$2
});
$c_Lvdb_ringer_RingerMain$.prototype.$$js$exported$meth$main__Lorg_scalajs_dom_raw_Element__O = (function(content) {
  this.main__Lorg_scalajs_dom_raw_Element__V(content)
});
$c_Lvdb_ringer_RingerMain$.prototype.main = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$main__Lorg_scalajs_dom_raw_Element__O(prep0)
});
var $d_Lvdb_ringer_RingerMain$ = new $TypeData().initClass({
  Lvdb_ringer_RingerMain$: 0
}, false, "vdb.ringer.RingerMain$", {
  Lvdb_ringer_RingerMain$: 1,
  O: 1
});
$c_Lvdb_ringer_RingerMain$.prototype.$classData = $d_Lvdb_ringer_RingerMain$;
var $n_Lvdb_ringer_RingerMain$ = (void 0);
function $m_Lvdb_ringer_RingerMain$() {
  if ((!$n_Lvdb_ringer_RingerMain$)) {
    $n_Lvdb_ringer_RingerMain$ = new $c_Lvdb_ringer_RingerMain$().init___()
  };
  return $n_Lvdb_ringer_RingerMain$
}
$e.vdb = ($e.vdb || {});
$e.vdb.ringer = ($e.vdb.ringer || {});
$e.vdb.ringer.RingerMain = $m_Lvdb_ringer_RingerMain$;
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
  this.data$1 = null
...
$c_s_concurrent_Future$.prototype.fromTry__s_util_Try__s_concurrent_Future = (function(result) {
  var this$2 = new $c_s_concurrent_impl_Promise$KeptPromise().init___s_util_Try(result);
  return this$2
});
...
$c_Lscalatags_JsDom$all$.prototype.br__Lscalatags_generic_TypedTag = (function() {
  ...
  var hi = (512 & b.hi$2);
  if ((hi === 0)) {
    return this.br$lzycompute__p1__Lscalatags_generic_TypedTag()
  } else {
    return this.br$1
  }
});
...
$c_Lscalatags_JsDom$all$.prototype.br$lzycompute__p1__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$0$1;
  var hi = (512 & b.hi$2);
  if ((hi === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1;
    this.br$1 = $s_Lscalatags_jsdom_TagFactory$class__typedTag__Lscalatags_jsdom_TagFactory__T__Z__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag(this, "br", true, ns);
    var b$1 = this.bitmap$0$1;
    var lo = b$1.lo$2;
...
$c_Lscalatags_JsDom$all$.prototype.textarea__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$1$1;
  var lo = (8192 & b.lo$2);
  if ((lo === 0)) {
    return this.textarea$lzycompute__p1__Lscalatags_generic_TypedTag()
  } else {
...
$c_Lscalatags_JsDom$all$.prototype.textarea$lzycompute__p1__Lscalatags_generic_TypedTag = (function() {
  var b = this.bitmap$1$1;
  var lo = (8192 & b.lo$2);
  if ((lo === 0)) {
    var ns = $m_Lscalatags_generic_Namespace$().htmlNamespaceConfig$1;
    this.textarea$1 = $s_Lscalatags_jsdom_TagFactory$class__typedTag__Lscalatags_jsdom_TagFactory__T__Z__Lscalatags_generic_Namespace__Lscalatags_generic_TypedTag(this, "textarea", false, ns);
...
//# sourceMappingURL=ringer-fastopt.js.map

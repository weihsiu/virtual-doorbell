...
/** @constructor */
function $c_Lorg_scalajs_dom_experimental_serviceworkers_ClientType$() {
  $c_O.call(this);
  this.window$1 = null;
  this.worker$1 = null;
  this.sharedworker$1 = null;
  this.all$1 = null
}
$c_Lorg_scalajs_dom_experimental_serviceworkers_ClientType$.prototype = new $h_O();
$c_Lorg_scalajs_dom_experimental_serviceworkers_ClientType$.prototype.constructor = $c_Lorg_scalajs_dom_experimental_serviceworkers_ClientType$;
/** @constructor */
function $h_Lorg_scalajs_dom_experimental_serviceworkers_ClientType$() {
  /*<skip>*/
}
$h_Lorg_scalajs_dom_experimental_serviceworkers_ClientType$.prototype = $c_Lorg_scalajs_dom_experimental_serviceworkers_ClientType$.prototype;
$c_Lorg_scalajs_dom_experimental_serviceworkers_ClientType$.prototype.init___ = (function() {
  this.window$1 = "window";
  this.worker$1 = "worker";
  this.sharedworker$1 = "sharedworker";
  this.all$1 = "all";
  return this
});
var $d_Lorg_scalajs_dom_experimental_serviceworkers_ClientType$ = new $TypeData().initClass({
  Lorg_scalajs_dom_experimental_serviceworkers_ClientType$: 0
}, false, "org.scalajs.dom.experimental.serviceworkers.ClientType$", {
  Lorg_scalajs_dom_experimental_serviceworkers_ClientType$: 1,
  O: 1
});
$c_Lorg_scalajs_dom_experimental_serviceworkers_ClientType$.prototype.$classData = $d_Lorg_scalajs_dom_experimental_serviceworkers_ClientType$;
var $n_Lorg_scalajs_dom_experimental_serviceworkers_ClientType$ = (void 0);
function $m_Lorg_scalajs_dom_experimental_serviceworkers_ClientType$() {
  if ((!$n_Lorg_scalajs_dom_experimental_serviceworkers_ClientType$)) {
    $n_Lorg_scalajs_dom_experimental_serviceworkers_ClientType$ = new $c_Lorg_scalajs_dom_experimental_serviceworkers_ClientType$().init___()
  };
  return $n_Lorg_scalajs_dom_experimental_serviceworkers_ClientType$
}
/** @constructor */
function $c_Lvdb_service_ServiceMain$() {
  $c_O.call(this)
}
$c_Lvdb_service_ServiceMain$.prototype = new $h_O();
$c_Lvdb_service_ServiceMain$.prototype.constructor = $c_Lvdb_service_ServiceMain$;
/** @constructor */
function $h_Lvdb_service_ServiceMain$() {
  /*<skip>*/
}
$h_Lvdb_service_ServiceMain$.prototype = $c_Lvdb_service_ServiceMain$.prototype;
$c_Lvdb_service_ServiceMain$.prototype.init___ = (function() {
  return this
});
$c_Lvdb_service_ServiceMain$.prototype.main__V = (function() {
  var self = $g.self;
  var this$4 = $m_s_Console$();
  var this$5 = $as_Ljava_io_PrintStream(this$4.outVar$2.v$1);
  this$5.java$lang$JSConsoleBasedPrintStream$$printString__T__V("in service main!\n");
  self.addEventListener("install", (function(self$1) {
    return (function(e$2) {
      self$1.skipWaiting();
      var x = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["installed ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([e$2]));
  ...
  self.addEventListener("activate", (function(e$2$1) {
    var x$1 = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["activated ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([e$2$1]));
  ...
  self.addEventListener("push", (function(self$1$1) {
    return (function(e$2$2) {
      var x$2 = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["pushed ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([e$2$2]));
      ...
      var registration = self$1$1.registration;
      var jsx$1 = new $c_Lvdb_service_ServiceWorkers$RichServiceWorkerRegistration().init___Lorg_scalajs_dom_experimental_serviceworkers_ServiceWorkerRegistration(registration);
      var result = {};
      result.body = "world";
      result.tag = "my tag";
      e$2$2.waitUntil(jsx$1.showNotification__T__Lorg_scalajs_dom_experimental_NotificationOptions__sjs_js_Promise("doorbell rang", result))
    })
  })(self));
  ...
  })(new $c_Lvdb_service_ServiceMain$$anonfun$main$4().init___Lorg_scalajs_dom_experimental_serviceworkers_ServiceWorkerGlobalScope(self)))
});
$c_Lvdb_service_ServiceMain$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Lvdb_service_ServiceMain$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Lvdb_service_ServiceMain$ = new $TypeData().initClass({
  Lvdb_service_ServiceMain$: 0
}, false, "vdb.service.ServiceMain$", {
  Lvdb_service_ServiceMain$: 1,
  O: 1
});
$c_Lvdb_service_ServiceMain$.prototype.$classData = $d_Lvdb_service_ServiceMain$;
var $n_Lvdb_service_ServiceMain$ = (void 0);
function $m_Lvdb_service_ServiceMain$() {
  if ((!$n_Lvdb_service_ServiceMain$)) {
    $n_Lvdb_service_ServiceMain$ = new $c_Lvdb_service_ServiceMain$().init___()
  };
  return $n_Lvdb_service_ServiceMain$
}
$e.vdb = ($e.vdb || {});
$e.vdb.service = ($e.vdb.service || {});
$e.vdb.service.ServiceMain = $m_Lvdb_service_ServiceMain$;
/** @constructor */
function $c_Lvdb_service_ServiceWorkers$ClientQueryOptions$() {
  $c_O.call(this)
}
$c_Lvdb_service_ServiceWorkers$ClientQueryOptions$.prototype = new $h_O();
$c_Lvdb_service_ServiceWorkers$ClientQueryOptions$.prototype.constructor = $c_Lvdb_service_ServiceWorkers$ClientQueryOptions$;
/** @constructor */
function $h_Lvdb_service_ServiceWorkers$ClientQueryOptions$() {
  /*<skip>*/
}
$h_Lvdb_service_ServiceWorkers$ClientQueryOptions$.prototype = $c_Lvdb_service_ServiceWorkers$ClientQueryOptions$.prototype;
$c_Lvdb_service_ServiceWorkers$ClientQueryOptions$.prototype.init___ = (function() {
  return this
});
$c_Lvdb_service_ServiceWorkers$ClientQueryOptions$.prototype.apply__Z__Lorg_scalajs_dom_experimental_serviceworkers_ClientType__Lorg_scalajs_dom_experimental_serviceworkers_ClientQueryOptions = (function(includeUncontrolled, type) {
  return {
    "includeUncontrolled": includeUncontrolled
  }
});
var $d_Lvdb_service_ServiceWorkers$ClientQueryOptions$ = new $TypeData().initClass({
  Lvdb_service_ServiceWorkers$ClientQueryOptions$: 0
}, false, "vdb.service.ServiceWorkers$ClientQueryOptions$", {
  Lvdb_service_ServiceWorkers$ClientQueryOptions$: 1,
  O: 1
});
$c_Lvdb_service_ServiceWorkers$ClientQueryOptions$.prototype.$classData = $d_Lvdb_service_ServiceWorkers$ClientQueryOptions$;
var $n_Lvdb_service_ServiceWorkers$ClientQueryOptions$ = (void 0);
function $m_Lvdb_service_ServiceWorkers$ClientQueryOptions$() {
  if ((!$n_Lvdb_service_ServiceWorkers$ClientQueryOptions$)) {
    $n_Lvdb_service_ServiceWorkers$ClientQueryOptions$ = new $c_Lvdb_service_ServiceWorkers$ClientQueryOptions$().init___()
  };
  return $n_Lvdb_service_ServiceWorkers$ClientQueryOptions$
}
/** @constructor */
function $c_Lvdb_service_ServiceWorkers$RichServiceWorkerRegistration() {
  $c_O.call(this);
  this.registration$1 = null
}
$c_Lvdb_service_ServiceWorkers$RichServiceWorkerRegistration.prototype = new $h_O();
$c_Lvdb_service_ServiceWorkers$RichServiceWorkerRegistration.prototype.constructor = $c_Lvdb_service_ServiceWorkers$RichServiceWorkerRegistration;
/** @constructor */
function $h_Lvdb_service_ServiceWorkers$RichServiceWorkerRegistration() {
  /*<skip>*/
}
$h_Lvdb_service_ServiceWorkers$RichServiceWorkerRegistration.prototype = $c_Lvdb_service_ServiceWorkers$RichServiceWorkerRegistration.prototype;
$c_Lvdb_service_ServiceWorkers$RichServiceWorkerRegistration.prototype.init___Lorg_scalajs_dom_experimental_serviceworkers_ServiceWorkerRegistration = (function(registration) {
  this.registration$1 = registration;
  return this
});
$c_Lvdb_service_ServiceWorkers$RichServiceWorkerRegistration.prototype.showNotification__T__Lorg_scalajs_dom_experimental_NotificationOptions__sjs_js_Promise = (function(title, options) {
  return this.registration$1.showNotification(title, options)
});
var $d_Lvdb_service_ServiceWorkers$RichServiceWorkerRegistration = new $TypeData().initClass({
  Lvdb_service_ServiceWorkers$RichServiceWorkerRegistration: 0
}, false, "vdb.service.ServiceWorkers$RichServiceWorkerRegistration", {
  Lvdb_service_ServiceWorkers$RichServiceWorkerRegistration: 1,
  O: 1
});
$c_Lvdb_service_ServiceWorkers$RichServiceWorkerRegistration.prototype.$classData = $d_Lvdb_service_ServiceWorkers$RichServiceWorkerRegistration;
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
  this.data$1 = null
...
$c_sjs_js_JSConverters$JSRichFuture$.prototype.init___ = (function() {
  return this
});
$c_sjs_js_JSConverters$JSRichFuture$.prototype.toJSPromise$extension__s_concurrent_Future__s_concurrent_ExecutionContext__sjs_js_Promise = (function($$this, executor) {
  return new $g.Promise((function($this, executor$1, $$this$1) {
    return (function(resolve$2, reject$2) {
      $$this$1.onComplete__F1__s_concurrent_ExecutionContext__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this$1, resolve, reject) {
      ...
      })($this, resolve$2, reject$2)), executor$1)
    })
  })(this, executor, $$this))
});
...
var $n_sjs_js_JSConverters$JSRichFuture$ = (void 0);
...
$c_sjsr_RuntimeLong.prototype.$classData = $d_sjsr_RuntimeLong;
/** @constructor */
function $c_Lvdb_service_ServiceMain$$anonfun$main$4() {
  $c_sr_AbstractFunction1.call(this);
  this.self$1$2 = null
}
$c_Lvdb_service_ServiceMain$$anonfun$main$4.prototype = new $h_sr_AbstractFunction1();
$c_Lvdb_service_ServiceMain$$anonfun$main$4.prototype.constructor = $c_Lvdb_service_ServiceMain$$anonfun$main$4;
/** @constructor */
function $h_Lvdb_service_ServiceMain$$anonfun$main$4() {
  /*<skip>*/
}
$h_Lvdb_service_ServiceMain$$anonfun$main$4.prototype = $c_Lvdb_service_ServiceMain$$anonfun$main$4.prototype;
$c_Lvdb_service_ServiceMain$$anonfun$main$4.prototype.apply__O__O = (function(v1) {
  this.apply__Lvdb_service_ServiceWorkers$NotificationEvent__V(v1)
});
$c_Lvdb_service_ServiceMain$$anonfun$main$4.prototype.init___Lorg_scalajs_dom_experimental_serviceworkers_ServiceWorkerGlobalScope = (function(self$1) {
  this.self$1$2 = self$1;
  return this
});
$c_Lvdb_service_ServiceMain$$anonfun$main$4.prototype.apply__Lvdb_service_ServiceWorkers$NotificationEvent__V = (function(e) {
  var x = new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["notification clicked ", ""])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([e]));
  var this$2 = $m_s_Console$();
  var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V((x + "\n"));
  e.notification.close();
  var jsx$3 = $m_sjs_js_JSConverters$JSRichFuture$();
  var jsx$2 = $m_sjs_js_Thenable$ThenableOps$();
  var jsx$1 = this.self$1$2.clients;
  var x$16 = $m_Lorg_scalajs_dom_experimental_serviceworkers_ClientType$().window$1;
  var value = $m_Lvdb_service_ServiceWorkers$ClientQueryOptions$().apply__Z__Lorg_scalajs_dom_experimental_serviceworkers_ClientType__Lorg_scalajs_dom_experimental_serviceworkers_ClientQueryOptions(false, x$16);
  var p = jsx$1.matchAll(value);
  var this$6 = jsx$2.toFuture$extension__sjs_js_Thenable__s_concurrent_Future(p);
  var f = new $c_Lvdb_service_ServiceMain$$anonfun$main$4$$anonfun$apply$1().init___Lvdb_service_ServiceMain$$anonfun$main$4(this);
  var executor = $m_sjs_concurrent_JSExecutionContext$Implicits$().queue$1;
  var f$1 = $s_s_concurrent_Future$class__map__s_concurrent_Future__F1__s_concurrent_ExecutionContext__s_concurrent_Future(this$6, f, executor);
  e.waitUntil(jsx$3.toJSPromise$extension__s_concurrent_Future__s_concurrent_ExecutionContext__sjs_js_Promise(f$1, $m_sjs_concurrent_JSExecutionContext$Implicits$().queue$1))
});
var $d_Lvdb_service_ServiceMain$$anonfun$main$4 = new $TypeData().initClass({
  Lvdb_service_ServiceMain$$anonfun$main$4: 0
}, false, "vdb.service.ServiceMain$$anonfun$main$4", {
  Lvdb_service_ServiceMain$$anonfun$main$4: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lvdb_service_ServiceMain$$anonfun$main$4.prototype.$classData = $d_Lvdb_service_ServiceMain$$anonfun$main$4;
/** @constructor */
function $c_Lvdb_service_ServiceMain$$anonfun$main$4$$anonfun$apply$1() {
  $c_sr_AbstractFunction1.call(this)
}
$c_Lvdb_service_ServiceMain$$anonfun$main$4$$anonfun$apply$1.prototype = new $h_sr_AbstractFunction1();
$c_Lvdb_service_ServiceMain$$anonfun$main$4$$anonfun$apply$1.prototype.constructor = $c_Lvdb_service_ServiceMain$$anonfun$main$4$$anonfun$apply$1;
/** @constructor */
function $h_Lvdb_service_ServiceMain$$anonfun$main$4$$anonfun$apply$1() {
  /*<skip>*/
}
$h_Lvdb_service_ServiceMain$$anonfun$main$4$$anonfun$apply$1.prototype = $c_Lvdb_service_ServiceMain$$anonfun$main$4$$anonfun$apply$1.prototype;
$c_Lvdb_service_ServiceMain$$anonfun$main$4$$anonfun$apply$1.prototype.apply__O__O = (function(v1) {
  this.apply__sjs_js_Array__V(v1)
});
$c_Lvdb_service_ServiceMain$$anonfun$main$4$$anonfun$apply$1.prototype.apply__sjs_js_Array__V = (function(cs) {
  var len = $uI(cs.length);
  var i = 0;
  while (true) {
    if ((i < len)) {
      var index = i;
...
$c_Lvdb_service_ServiceMain$$anonfun$main$4$$anonfun$apply$1.prototype.init___Lvdb_service_ServiceMain$$anonfun$main$4 = (function($$outer) {
  return this
});
var $d_Lvdb_service_ServiceMain$$anonfun$main$4$$anonfun$apply$1 = new $TypeData().initClass({
  Lvdb_service_ServiceMain$$anonfun$main$4$$anonfun$apply$1: 0
}, false, "vdb.service.ServiceMain$$anonfun$main$4$$anonfun$apply$1", {
  Lvdb_service_ServiceMain$$anonfun$main$4$$anonfun$apply$1: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lvdb_service_ServiceMain$$anonfun$main$4$$anonfun$apply$1.prototype.$classData = $d_Lvdb_service_ServiceMain$$anonfun$main$4$$anonfun$apply$1;
/** @constructor */
...
vdb.service.ServiceMain().main();
//# sourceMappingURL=service-fastopt.js.map
